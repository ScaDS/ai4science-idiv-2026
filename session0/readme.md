# Setting up your computer for AI-assisted programming (optional)

This chapter provides instructions for setting up your computer to run Python and use AI-assisted code generation to analyse data.
